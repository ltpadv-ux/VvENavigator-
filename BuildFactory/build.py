...
VERSION="15.5.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","rebalanced_scenario_verification_confidence_gate","risk_appetite_breach_remediation_rebalancing","probability_aware_scenario_risk_appetite","digital_twin_scenario_probability_monte_carlo","adaptive_vve_financial_digital_twin","enterprise","modules"]

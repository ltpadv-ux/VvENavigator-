...
VERSION="16.6.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_doctor():
 files=["model_drift_root_cause_recalibration.py","post_promotion_stability_model_drift_watchdog.py","controlled_model_promotion_version_freeze_rollback.py","shadow_run_live_parallel_validation.py","model_champion_challenger_validation.py","model_backtesting_forecast_accuracy_scorecard.py","autonomous_governance_learning_loop.py","baseline_breach_diagnosis_corrective_action.py","scenario_activation_baseline_monitoring_covenant.py","rebalanced_scenario_verification_confidence_gate.py","probability_aware_scenario_risk_appetite.py","digital_twin_scenario_probability_monte_carlo.py","digital_twin_scenario_branching_what_if.py","adaptive_vve_financial_digital_twin.py","integrated_financial_governance_decision_cockpit.py","finance_engine.py","mjop_engine.py","risk_engine.py","governance_engine.py","audit_engine.py","excel_master.py"]
...
def cmd_status():
 c=load_config(); keys=["project","model_drift_root_cause_recalibration","post_promotion_stability_model_drift_watchdog","controlled_model_promotion_version_freeze_rollback","enterprise","modules"]

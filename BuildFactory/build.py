...
VERSION="12.8.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","constitutional_activation_cutover_control","constitutional_impact_migration_control","constitutional_version_ledger","constitutional_remediation_amendment_register","constitutional_debt_remediation","constitutional_compliance_gatekeeper","governance_constitution_control_framework","executive_command_center","enterprise","modules"]

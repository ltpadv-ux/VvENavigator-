...
VERSION="18.2.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","ga_release_execution_immutable_evidence_archive","ga_evidence_closure_release_tag_readiness","production_ga_release_gate","enterprise","release","modules"]

...
VERSION="16.1.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","model_backtesting_forecast_accuracy_scorecard","autonomous_governance_learning_loop","baseline_breach_diagnosis_corrective_action","enterprise","modules"]

...
VERSION="7.4.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","portfolio_funding_covenant_control","portfolio_funding_strategy","portfolio_capital_allocation","portfolio_intelligence","closed_loop_management","execution_benefits_tracking","enterprise","modules"]

...
VERSION="4.2.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","production_orchestrator","production_verification","verification_diagnostics","decision_intelligence","executive_cockpit","executive_reporting","publication","document_rendering","artifact_generation","native_export","binary_renderers","release_packaging","release_validation","enterprise","health","policy","portfolio","forecast","stress_test","optimization","strategy_optimizer","recommendation","modules"]

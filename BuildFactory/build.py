...
VERSION="12.5.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","constitutional_remediation_amendment_register","constitutional_debt_remediation","waiver_monitoring_constitutional_debt","constitutional_exception_waiver_register","constitutional_compliance_gatekeeper","governance_constitution_control_framework","executive_command_center","enterprise","modules"]

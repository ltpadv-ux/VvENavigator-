...
VERSION="9.0.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","vve_governance_operating_system","governance_improvement_roadmap","governance_maturity_index","audit_remediation","treasury_audit_assurance","portfolio_treasury_control_tower","closed_loop_management","enterprise","modules"]

...
VERSION="7.7.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","treasury_stress_intervention","treasury_forecast","portfolio_liquidity_debt_control","portfolio_funding_covenant_control","portfolio_funding_strategy","portfolio_capital_allocation","portfolio_intelligence","closed_loop_management","enterprise","modules"]

...
VERSION="14.8.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","financial_close_accrual_audit_evidence_pack","payment_reconciliation_bank_statement_control","payment_authorization_dual_approval_fraud_control","enterprise","modules"]

...
VERSION="14.6.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","payment_authorization_dual_approval_fraud_control","invoice_validation_contract_three_way_control","execution_commitment_ledger_budget_burn","financial_resolution_execution_mandate_budget_lock","enterprise","modules"]

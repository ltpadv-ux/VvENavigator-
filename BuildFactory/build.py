...
VERSION="15.6.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_doctor():
 files=["confidence_gated_board_alv_scenario_resolution_pack.py","rebalanced_scenario_verification_confidence_gate.py","risk_appetite_breach_remediation_rebalancing.py","probability_aware_scenario_risk_appetite.py","digital_twin_scenario_probability_monte_carlo.py","digital_twin_scenario_branching_what_if.py","adaptive_vve_financial_digital_twin.py","financial_close_variance_forecast_feedback.py","integrated_financial_governance_decision_cockpit.py","finance_engine.py","mjop_engine.py","risk_engine.py","governance_engine.py","audit_engine.py","excel_master.py"]
...
def cmd_status():
 c=load_config(); keys=["project","confidence_gated_board_alv_scenario_resolution_pack","rebalanced_scenario_verification_confidence_gate","probability_aware_scenario_risk_appetite","digital_twin_scenario_probability_monte_carlo","adaptive_vve_financial_digital_twin","enterprise","modules"]

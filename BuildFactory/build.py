...
VERSION="10.7.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","preventive_learning_library","preventive_action_effectiveness","preventive_board_early_action_mandate","preventive_intervention_simulator","predictive_trend_break_radar","executive_pulse_trend_intelligence","executive_decision_pulse","executive_command_center","enterprise","modules"]

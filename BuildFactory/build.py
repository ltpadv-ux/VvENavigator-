...
VERSION="17.4.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","production_evidence_runner_rc1_closure_pack","rc1_evidence_closure_final_go_no_go","final_production_validation_rc1","enterprise","release","modules"]

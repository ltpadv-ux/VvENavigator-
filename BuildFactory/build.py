...
VERSION="19.0.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_doctor():
 files=["final_enterprise_production_baseline_handover.py","steady_state_operations_continuous_assurance.py","post_ga_monitoring_operational_acceptance.py","ga_release_execution_immutable_evidence_archive.py","ga_evidence_closure_release_tag_readiness.py","production_ga_release_gate.py","final_production_evidence_completion_release_authorization.py","production_release_evidence_closure_final_go.py","final_evidence_reconciliation_production_release_manifest.py","ci_run_result_closure_rc1_ingestion.py","ci_workflow_verification_evidence_harvesting.py","production_evidence_runner_rc1_closure_pack.py","rc1_evidence_closure_final_go_no_go.py","final_production_validation_rc1.py","production_release_candidate_go_no_go.py","security_access_release_hardening_gate.py","backup_restore_data_integrity_disaster_recovery.py","automated_regression_matrix_ci_evidence_gate.py","end_to_end_integration_quality_gate.py","finance_engine.py","mjop_engine.py","risk_engine.py","governance_engine.py","audit_engine.py","excel_master.py"]
...
def cmd_status():
 c=load_config(); keys=["project","final_enterprise_production_baseline_handover","steady_state_operations_continuous_assurance","enterprise","release","modules"]

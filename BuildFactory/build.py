...
VERSION="14.1.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","board_decision_alv_financial_resolution_pack","integrated_financial_governance_decision_cockpit","contribution_path_stress_test_payment_shock","contribution_smoothing_multi_year_funding_optimizer","member_contribution_affordability_fairness","preventive_governance_funding_reserve_impact","constitutional_governance_control_tower","constitutional_compliance_gatekeeper","governance_constitution_control_framework","executive_command_center","enterprise","modules"]

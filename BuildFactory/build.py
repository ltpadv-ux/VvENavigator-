...
VERSION="14.7.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_doctor():
 files=["payment_reconciliation_bank_statement_control.py","payment_authorization_dual_approval_fraud_control.py","invoice_validation_contract_three_way_control.py","execution_commitment_ledger_budget_burn.py","financial_resolution_execution_mandate_budget_lock.py","alv_voting_quorum_financial_resolution_validation.py","board_decision_alv_financial_resolution_pack.py","integrated_financial_governance_decision_cockpit.py","resolution_execution_compliance.py","finance_engine.py","mjop_engine.py","risk_engine.py","governance_engine.py","audit_engine.py","excel_master.py"]
...
def cmd_status():
 c=load_config(); keys=["project","payment_reconciliation_bank_statement_control","payment_authorization_dual_approval_fraud_control","invoice_validation_contract_three_way_control","execution_commitment_ledger_budget_burn","financial_resolution_execution_mandate_budget_lock","enterprise","modules"]

...
VERSION="9.6.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","predictive_corrective_action_optimizer","strategic_mandate_variance_control","predictive_board_mandate","predictive_decision_portfolio","predictive_intervention_optimizer","executive_digital_twin","vve_governance_operating_system","enterprise","modules"]

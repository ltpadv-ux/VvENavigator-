...
VERSION="9.9.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","autonomous_governance_recommendation","strategic_amendment_effectiveness","corrective_board_mandate_amendment","strategic_mandate_variance_control","executive_digital_twin","vve_governance_operating_system","enterprise","modules"]

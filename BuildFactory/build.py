...
VERSION="15.3.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_doctor():
 files=["probability_aware_scenario_risk_appetite.py","digital_twin_scenario_probability_monte_carlo.py","digital_twin_scenario_branching_what_if.py","adaptive_vve_financial_digital_twin.py","financial_close_variance_forecast_feedback.py","integrated_financial_governance_decision_cockpit.py","finance_engine.py","mjop_engine.py","risk_engine.py","governance_engine.py","audit_engine.py","excel_master.py"]
...
def cmd_status():
 c=load_config(); keys=["project","probability_aware_scenario_risk_appetite","digital_twin_scenario_probability_monte_carlo","digital_twin_scenario_branching_what_if","adaptive_vve_financial_digital_twin","enterprise","modules"]

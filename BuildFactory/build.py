...
VERSION="18.0.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","production_ga_release_gate","final_production_evidence_completion_release_authorization","enterprise","release","modules"]

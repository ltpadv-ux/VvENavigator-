...
VERSION="6.4.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_doctor():
 files=["strategy_execution_scorecard.py","scenario_strategy_lock.py","strategic_scenario_radar.py","executive_risk_radar.py","governance_control_tower.py","amendment_effectiveness.py","mandate_amendment_engine.py","corrective_decision_workflow.py","corrective_action_optimizer.py","mandate_forecast.py","mandate_compliance.py","alv_mandate_control.py","alv_decision_workflow.py","governance_decision_register.py","autonomous_governance.py","decision_intelligence.py","executive_cockpit.py","executive_reporting.py","production_orchestrator.py","production_verification.py","self_healing.py","release_control_center.py","release_history.py","reliability_sla.py","improvement_backlog.py","enterprise_core.py","mjop_engine.py","finance_engine.py","financial_cockpit.py","risk_engine.py","governance_engine.py","audit_engine.py","compliance_engine.py","dashboard_engine.py","report_engine.py","datahub.py","excel_master.py","scenario_engine.py"]
...
def cmd_status():
 c=load_config(); keys=["project","strategy_execution_scorecard","scenario_strategy_lock","strategic_scenario_radar","executive_risk_radar","governance_control_tower","amendment_effectiveness","mandate_amendment_engine","corrective_decision_workflow","mandate_forecast","mandate_compliance","alv_mandate_control","alv_decision_workflow","governance_decision_register","autonomous_governance","enterprise","modules"]

...
VERSION="15.8.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","scenario_activation_baseline_monitoring_covenant","alv_scenario_vote_validation_activation_mandate","confidence_gated_board_alv_scenario_resolution_pack","enterprise","modules"]

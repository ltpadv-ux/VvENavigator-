...
VERSION="9.3.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","predictive_decision_portfolio","predictive_intervention_optimizer","executive_digital_twin","vve_governance_operating_system","governance_improvement_roadmap","governance_maturity_index","portfolio_treasury_control_tower","enterprise","modules"]

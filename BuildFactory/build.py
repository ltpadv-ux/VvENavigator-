...
VERSION="16.0.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","autonomous_governance_learning_loop","baseline_breach_diagnosis_corrective_action","scenario_activation_baseline_monitoring_covenant","enterprise","modules"]

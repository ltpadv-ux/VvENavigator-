...
VERSION="11.0.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","explainable_governance_ai","intervention_confidence_readiness","evidence_based_intervention_recommendation","preventive_learning_library","predictive_trend_break_radar","executive_command_center","enterprise","modules"]

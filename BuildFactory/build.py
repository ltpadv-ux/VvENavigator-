...
VERSION="10.0.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","executive_command_center","autonomous_governance_recommendation","strategic_amendment_effectiveness","executive_digital_twin","vve_governance_operating_system","portfolio_treasury_control_tower","treasury_audit_assurance","enterprise","modules"]

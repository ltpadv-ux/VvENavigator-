...
VERSION="16.5.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","post_promotion_stability_model_drift_watchdog","controlled_model_promotion_version_freeze_rollback","shadow_run_live_parallel_validation","model_champion_challenger_validation","enterprise","modules"]

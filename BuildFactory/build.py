...
VERSION="10.3.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","predictive_trend_break_radar","executive_pulse_trend_intelligence","executive_decision_pulse","executive_command_center","autonomous_governance_recommendation","executive_digital_twin","vve_governance_operating_system","enterprise","modules"]

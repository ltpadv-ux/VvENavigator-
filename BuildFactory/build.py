...
VERSION="17.6.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","ci_run_result_closure_rc1_ingestion","ci_workflow_verification_evidence_harvesting","production_evidence_runner_rc1_closure_pack","rc1_evidence_closure_final_go_no_go","enterprise","release","modules"]

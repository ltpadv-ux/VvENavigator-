...
VERSION="17.3.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","rc1_evidence_closure_final_go_no_go","final_production_validation_rc1","production_release_candidate_go_no_go","enterprise","release","modules"]

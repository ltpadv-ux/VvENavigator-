...
VERSION="14.5.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_doctor():
 files=["invoice_validation_contract_three_way_control.py","execution_commitment_ledger_budget_burn.py","financial_resolution_execution_mandate_budget_lock.py","alv_voting_quorum_financial_resolution_validation.py","board_decision_alv_financial_resolution_pack.py","integrated_financial_governance_decision_cockpit.py","contribution_path_stress_test_payment_shock.py","contribution_smoothing_multi_year_funding_optimizer.py","member_contribution_affordability_fairness.py","preventive_governance_funding_reserve_impact.py","constitutional_governance_control_tower.py","formal_resolution_voting_register.py","resolution_execution_compliance.py","finance_engine.py","mjop_engine.py","risk_engine.py","governance_engine.py","audit_engine.py","excel_master.py"]
...
def cmd_status():
 c=load_config(); keys=["project","invoice_validation_contract_three_way_control","execution_commitment_ledger_budget_burn","financial_resolution_execution_mandate_budget_lock","enterprise","modules"]

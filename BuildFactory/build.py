...
VERSION="17.0.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","security_access_release_hardening_gate","backup_restore_data_integrity_disaster_recovery","automated_regression_matrix_ci_evidence_gate","end_to_end_integration_quality_gate","enterprise","release","modules"]

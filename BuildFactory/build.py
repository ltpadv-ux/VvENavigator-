...
VERSION="6.9.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","execution_benefits_tracking","intervention_execution_mandate","intervention_decision_matrix","intervention_impact_simulator","strategy_intervention_engine","strategy_execution_scorecard","scenario_strategy_lock","strategic_scenario_radar","executive_risk_radar","governance_control_tower","enterprise","modules"]

...
VERSION="9.8.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","strategic_amendment_effectiveness","corrective_board_mandate_amendment","predictive_corrective_action_optimizer","strategic_mandate_variance_control","predictive_board_mandate","executive_digital_twin","vve_governance_operating_system","enterprise","modules"]

...
VERSION="15.9.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_doctor():
 files=["baseline_breach_diagnosis_corrective_action.py","scenario_activation_baseline_monitoring_covenant.py","alv_scenario_vote_validation_activation_mandate.py","confidence_gated_board_alv_scenario_resolution_pack.py","rebalanced_scenario_verification_confidence_gate.py","risk_appetite_breach_remediation_rebalancing.py","probability_aware_scenario_risk_appetite.py","digital_twin_scenario_probability_monte_carlo.py","digital_twin_scenario_branching_what_if.py","adaptive_vve_financial_digital_twin.py","integrated_financial_governance_decision_cockpit.py","finance_engine.py","mjop_engine.py","risk_engine.py","governance_engine.py","audit_engine.py","excel_master.py"]
...
def cmd_status():
 c=load_config(); keys=["project","baseline_breach_diagnosis_corrective_action","scenario_activation_baseline_monitoring_covenant","alv_scenario_vote_validation_activation_mandate","enterprise","modules"]

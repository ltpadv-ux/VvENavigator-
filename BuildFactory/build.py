...
VERSION="7.2.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","portfolio_capital_allocation","portfolio_intelligence","closed_loop_management","execution_benefits_tracking","intervention_execution_mandate","strategy_execution_scorecard","enterprise","modules"]

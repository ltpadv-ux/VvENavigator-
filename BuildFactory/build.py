...
VERSION="8.4.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_doctor():
 files=["treasury_decision_effectiveness.py","treasury_accountability_register.py","treasury_decision_board_pack.py","treasury_early_warning_calendar.py","portfolio_treasury_control_tower.py","treasury_recovery_effectiveness.py","treasury_recovery_mandate.py","treasury_stress_intervention.py","treasury_forecast.py","portfolio_liquidity_debt_control.py","portfolio_funding_covenant_control.py","portfolio_funding_strategy.py","portfolio_capital_allocation.py","portfolio_intelligence.py","closed_loop_management.py","execution_benefits_tracking.py","intervention_execution_mandate.py","intervention_decision_matrix.py","intervention_impact_simulator.py","strategy_intervention_engine.py","strategy_execution_scorecard.py","scenario_strategy_lock.py","strategic_scenario_radar.py","executive_risk_radar.py","governance_control_tower.py","portfolio_engine.py","production_orchestrator.py","production_verification.py","enterprise_core.py","mjop_engine.py","finance_engine.py","financial_cockpit.py","risk_engine.py","governance_engine.py","audit_engine.py","compliance_engine.py","dashboard_engine.py","report_engine.py","datahub.py","excel_master.py","scenario_engine.py"]
...
def cmd_status():
 c=load_config(); keys=["project","treasury_decision_effectiveness","treasury_accountability_register","treasury_decision_board_pack","treasury_early_warning_calendar","portfolio_treasury_control_tower","treasury_recovery_effectiveness","treasury_recovery_mandate","treasury_stress_intervention","treasury_forecast","portfolio_liquidity_debt_control","portfolio_funding_covenant_control","portfolio_funding_strategy","portfolio_capital_allocation","portfolio_intelligence","closed_loop_management","enterprise","modules"]

...
VERSION="18.3.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","post_ga_monitoring_operational_acceptance","ga_release_execution_immutable_evidence_archive","enterprise","release","modules"]

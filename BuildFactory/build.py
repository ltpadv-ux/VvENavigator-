...
VERSION="16.4.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","controlled_model_promotion_version_freeze_rollback","shadow_run_live_parallel_validation","model_champion_challenger_validation","model_backtesting_forecast_accuracy_scorecard","autonomous_governance_learning_loop","enterprise","modules"]

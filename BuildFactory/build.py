...
VERSION="16.7.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","end_to_end_integration_quality_gate","model_drift_root_cause_recalibration","post_promotion_stability_model_drift_watchdog","enterprise","modules"]

...
VERSION="17.7.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","final_evidence_reconciliation_production_release_manifest","ci_run_result_closure_rc1_ingestion","production_evidence_runner_rc1_closure_pack","rc1_evidence_closure_final_go_no_go","enterprise","release","modules"]

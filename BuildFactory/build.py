...
VERSION="14.2.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","alv_voting_quorum_financial_resolution_validation","board_decision_alv_financial_resolution_pack","integrated_financial_governance_decision_cockpit","enterprise","modules"]

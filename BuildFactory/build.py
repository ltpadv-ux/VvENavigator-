...
VERSION="15.7.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","alv_scenario_vote_validation_activation_mandate","confidence_gated_board_alv_scenario_resolution_pack","rebalanced_scenario_verification_confidence_gate","probability_aware_scenario_risk_appetite","enterprise","modules"]

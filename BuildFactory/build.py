...
VERSION="11.6.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","institutional_memory_precedent_intelligence","governance_archive_memory","resolution_closure_governance_discharge","resolution_execution_compliance","formal_resolution_voting_register","board_decision_alv_pack","explainable_governance_ai","intervention_confidence_readiness","executive_command_center","enterprise","modules"]

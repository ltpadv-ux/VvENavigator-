...
VERSION="17.8.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","production_release_evidence_closure_final_go","final_evidence_reconciliation_production_release_manifest","enterprise","release","modules"]

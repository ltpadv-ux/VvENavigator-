...
VERSION="3.7.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","decision_intelligence","executive_cockpit","executive_reporting","publication","document_rendering","artifact_generation","native_export","binary_renderers","enterprise","health","policy","portfolio","forecast","stress_test","optimization","strategy_optimizer","recommendation","modules"]

...
VERSION="13.1.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","constitutional_governance_pulse","constitutional_governance_control_tower","post_activation_assurance_rollback_control","constitutional_activation_cutover_control","constitutional_impact_migration_control","constitutional_version_ledger","constitutional_compliance_gatekeeper","governance_constitution_control_framework","executive_command_center","enterprise","modules"]

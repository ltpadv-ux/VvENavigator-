...
VERSION="10.8.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","evidence_based_intervention_recommendation","preventive_learning_library","preventive_action_effectiveness","preventive_board_early_action_mandate","predictive_trend_break_radar","executive_command_center","enterprise","modules"]

...
VERSION="8.9.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","governance_improvement_roadmap","governance_maturity_index","audit_remediation","treasury_audit_assurance","portfolio_treasury_control_tower","closed_loop_management","enterprise","modules"]

...
VERSION="11.1.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","board_decision_alv_pack","explainable_governance_ai","intervention_confidence_readiness","evidence_based_intervention_recommendation","executive_command_center","enterprise","modules"]

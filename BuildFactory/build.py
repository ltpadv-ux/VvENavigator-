...
VERSION="14.0.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","integrated_financial_governance_decision_cockpit","contribution_path_stress_test_payment_shock","contribution_smoothing_multi_year_funding_optimizer","member_contribution_affordability_fairness","preventive_governance_funding_reserve_impact","preventive_governance_scenario_optimizer","preventive_governance_intervention_planner","constitutional_governance_forecast_time_to_red","constitutional_governance_trend_drift_radar","constitutional_governance_pulse","constitutional_governance_control_tower","constitutional_compliance_gatekeeper","governance_constitution_control_framework","executive_command_center","enterprise","modules"]

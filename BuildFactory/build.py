...
VERSION="8.7.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","audit_remediation","treasury_audit_assurance","treasury_audit_lineage","treasury_decision_effectiveness","treasury_accountability_register","treasury_decision_board_pack","treasury_early_warning_calendar","portfolio_treasury_control_tower","treasury_forecast","portfolio_liquidity_debt_control","portfolio_funding_covenant_control","portfolio_funding_strategy","portfolio_capital_allocation","portfolio_intelligence","closed_loop_management","enterprise","modules"]

...
VERSION="12.2.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","constitutional_exception_waiver_register","constitutional_compliance_gatekeeper","governance_constitution_control_framework","governance_policy_baseline_doctrine","executive_command_center","enterprise","modules"]

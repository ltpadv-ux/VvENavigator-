...
VERSION="12.0.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","governance_constitution_control_framework","governance_policy_baseline_doctrine","governance_policy_drift_detection","precedent_aware_decision_consistency","executive_command_center","enterprise","modules"]

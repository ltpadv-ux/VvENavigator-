...
VERSION="18.4.0"; ROOT=Path(__file__).resolve().parent; CONFIG=ROOT/"config"/"navigator.json"
...
def cmd_status():
 c=load_config(); keys=["project","steady_state_operations_continuous_assurance","post_ga_monitoring_operational_acceptance","enterprise","release","modules"]

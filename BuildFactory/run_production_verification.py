...
def main()->int:
 ...
 mandates=build_execution_mandates(alv,existing_mandates); compliance=evaluate_mandate_compliance(mandates); governed_mandates={**mandates,"mandates":compliance["mandates"],"compliance_status":compliance["status"]}; forecast=forecast_mandates(governed_mandates,warning_days=a.mandate_warning_days); optimizer=optimize_corrective_actions(forecast)
